...
export const skillText = [
    {
        title: "나의 도전",
        desc: "도전의지를 가지는 것은 성공의 첫걸음입니다.어떤 어려움이든 극복 가능하다는 자신감을 가지고 두려움을 떨쳐버리고 도전하세요."
    },
    {
        title: "나의 도전",
        desc: "도전의지를 가지는 것은 성공의 첫걸음입니다.어떤 어려움이든 극복 가능하다는 자신감을 가지고 두려움을 떨쳐버리고 도전하세요."
...
export const siteText = [
    {
        text: ["make", "site complit width", "webstandard"],
        title: "VITE를 이용한 사이트 제작",
        code: "https://github.com",
        view: "https://green-vite-project.netlify.app",
        info: ["site coding", "production period : two days", "use stack : html5/css, css variable, vite"]
    },
    {
        text: ["make", "site complit width", "webstandard"],
        title: "VITE를 이용한 사이트 제작",
...
export const contactText = [
    {
        ...
        title: "KAKAO : chfhrdk_1",
    },
    {
        link: "mailto:chfhrdk_1@naver.com",
        title: "mail : chfhrdk_1@naver.com",
    },
];
